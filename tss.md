...
<img class="myImages" id="myImg" src="/assets/images/avatar.jpg" alt="Fishermen's cabins in Lofoten, Norway" style="width:100%;max-width:300px;margin:auto;">
<p style="font-size: 0.75em;text-align:center;">Click to view larger size image.</p>
...
<img class="myImages" id="myImg" src="/assets/images/TSS.png" style="width:100%;max-width:300px;margin:auto;">

...
<img class="myImages" id="myImg" src="/assets/images/avatar.jpg" alt="Fishermen's cabins in Lofoten, Norway" style="width:100%;max-width:300px;margin-left:auto;margin-right:auto;">
...
<img class="myImages" id="myImg" src="/assets/images/TSS.png" style="width:100%;max-width:300px;margin-left:auto;margin-right:auto;">
<p style="font-size: 0.75em;text-align:center;">Click image to enlargen.</p>
